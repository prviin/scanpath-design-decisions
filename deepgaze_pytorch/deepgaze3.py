...
def build_scanpath_network():
    return nn.Sequential(OrderedDict([
        ('encoding0',
         FlexibleScanpathHistoryEncoding(in_fixations=4, channels_per_fixation=3, out_channels=128, kernel_size=[1, 1],
                                         bias=True)),
        ('softplus0', nn.Softplus()),
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            self.load_state_dict(
                model_zoo.load_url('https://github.com/matthias-k/DeepGaze/releases/download/v1.1.0/deepgaze3.pth',
